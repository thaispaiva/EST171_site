...
## Exemplo 4: Seguro com despesas

## encontre o prêmio bruto
...
## Exemplo 5: Reserva com despesas

## encontre o prêmio puro
##

## encontre o prêmio bruto
##

## encontre a reserva líquida
##

## encontre a reserva bruta
##
...
- Gere uma amostra de $n=10.000$ tempos de vida ao nascer de acordo com a tabela do SOA. Fixe a semente como `2018`.
...
- Encontre o menor prêmio que a seguradora pode cobrar para garantir que a probabilidade de perda negativa não seja maior do que 5\%.
...
- Calcule o valor a ser cobrado de cada aposentado para que a probabilidade da seguradora ter uma perda negativa seja de no máximo 1\%.
...
set.seed(1405)
ax65 = rLifeContingencies(100000, lifecontingency="axn", object=soa08Act, x=65, parallel=TRUE)
