...
```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/Ax.png")
```

- Seguro Dotal Puro:

```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/nEx.png")
```
...
```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/nAx.png")
```

- VPA de Seguro de vida temporário:

```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/seg_temp.png")
```
...
- Por exemplo, conside um seguro temporário por $n$ anos que paga $k+1$ se $x$ completou $k$ anos desde o início do contrato, ou seja, se $K_x = k$ para $k=0,1,\dots,n-1$.

```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/IAx.png")
```
...
```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/seg_cresc.png")
```
...
```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/Ax_mpartes.png")
```
...
```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/Axn_Axn_mpartes.png")
```
...
```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/anndue.png")
```

- VPA de Anuidade de vida inteira *postecipada*:

```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/annimmed.png")
```
...
```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/anndue_diferida.png")
```

- VPA de Anuidade de vida *antecipada* e *temporária*:

```{r fig.align='center', echo=FALSE, purl=FALSE}
include_graphics("img/anndue_temporaria.png")
```
...
(Para anuidade postecipada: `type="arrears"`)
