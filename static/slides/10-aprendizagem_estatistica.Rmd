...
`credit_history`: histórico em empréstimos (*categórica*: já atrasou pagamento, conta crítica, nunca pegou/pagou corretamente)
...
- Agora vamos calcular a estatística V de Cramer entre a <span class="blue">variável reposta</span> e todas as <span class="blue">covariáveis</span>.
