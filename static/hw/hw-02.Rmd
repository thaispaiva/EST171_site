...
date: "Entrega: **01/04/2018** via Moodle (até as 23:55)"
output: 
  html_document: 
    css: hw.css
    theme: yeti
...
1) Escreva uma função `seqrep(n)` que retorne o vetor `(1; 2; 2; 3; 3; 3; : : : ; n)` onde cada inteiro $k$ é repetido $k$ vezes. Qual é o tamanho desse vetor para `n=50`? (Não imprima o vetor todo, acesse apenas o seu tamanho.)
