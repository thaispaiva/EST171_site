...
date: "Entrega: **20/05/2018** via Moodle (até as 23:55)"
output: 
  html_document: 
    css: hw.css
    theme: yeti
...
8) Um segurado de 65 anos quer contratar uma anuidade antecipada, anual e vitalícia de \$1.000. Encontre o menor prêmio único que a seguradora pode cobrar para garantir que a probabilidade de perda negativa não seja maior do que 25\%.
